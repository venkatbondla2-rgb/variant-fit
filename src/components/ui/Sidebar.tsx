...
import { Home, LineChart, Dumbbell, Trophy, HelpCircle, Users, Activity, Bell, User, MessageCircle, Shield, Camera, BookOpen, BarChart3, Bookmark, Film, Crown } from "lucide-react";
...
export function Sidebar() {
  ...
  const links = [
    ...
    { href: "/vites", label: "Vites", icon: <Film className="w-5 h-5" /> },
  ...
  return (
    <div className="hidden sm:flex flex-col w-64 h-[calc(100vh-4rem)] fixed left-0 top-16 border-r border-border p-6 bg-background/95 backdrop-blur z-40 overflow-y-auto">
